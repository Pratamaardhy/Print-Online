...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2022 at 02:16 PM
...
INSERT INTO `tb_order` (`id_order`, `id_jp`, `id_uk`, `jumlah_halaman`, `jml_order`, `id_jo`, `id_op`, `id_mp`, `link_dokumen`) VALUES
(19, 1, 1, 1, 1, 0, 1, 2, 'https://drive.google.com/file/d/1IiTqASGESgM8ByI7N1t-bRXMzQU2penr/view?usp=drivesdk');
...
(0, 'Geluran 1/24 A RT 01 RW 01 Geluran Taman', 'Jawa Timur', 'Kota Malang', 'jne', 'YES', '1000', '14000', '1-1 hari', '082244026525');
...
(0, 'userbaru', '$2y$10$TuVkRZ9IpM1wYnhWJTruM.3S9lxkEpcDUcy1o.2O7jDuKEdYpksby', 'Hanif Al Fathoni', 'user'),
...
--
ALTER TABLE `tb_order`
  MODIFY `id_order` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
